 ...
 *   as  methods with the `$` prefix. This allows you to easily perform CRUD operations (creator,
 ...
 * ```js
     ...
     // we can creator an instance as well
 ...
 * operations (creator, read, update, delete) on server-side data.
 ...
 *
 * In this example we creator a custom method on our resource to make a PUT request
 * ```js
